    <!-- footer style three -->
    <footer class="rts__section rts__footer is__home__four footer__background">
        <div class="container">
            <div class="row">
                <div class="footer__widget__wrapper">
                    <div class="rts__widget">
                        <a href="{{route('index')}}"><img src="{{asset('assets/images/logo/logo__two.svg')}}" alt="footer logo"></a>
                    ...
                    <div class="rts__widget">
                        ...
                        <ul>
                            ...
                            <li><a href="#"><i class="flaticon-marker"></i> 280 Augusta Avenue, M5T 2L9 Toronto, Canada</a></li>
                        </ul>
                    </div>
