...
@section('content')
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div class="banner__slide__content">
                                ...
                                <a href="{{route('room-three')}}" class="theme-btn btn-style fill no-border "><span>Discover Room</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div class="banner__slide__content">
                                ...
                                <p class="sub__text">Choosing Bokinn was one of the best decisions we've ever made. They have proven to be a reliable and innovative partner</p>
                                <a href="{{route('room-four')}}" class="theme-btn btn-style fill no-border "><span>Discover Room</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="room__slide__box radius-6">
                                ...
                                <div class="room__content">
                                    <a href="{{route('room-details-1')}}" class="room__title"><h5>The Ritz-Carlton</h5></a>
                        ...
                        <div class="swiper-slide">
                            <div class="room__slide__box radius-6">
                                ...
                                <div class="room__content">
                                    <a href="{{route('room-details-1')}}" class="room__title"><h5>Four Seasons Hotels</h5></a>
                                    <div class="room__content__meta">
                                        <span><i class="flaticon-construction"></i>35 sqm</span>
                                        <span><i class="flaticon-user"></i>2 Person</span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="room__slide__box radius-6">
                                ...
                                <div class="room__content">
                                    <a href="{{route('room-details-1')}}" class="room__title"><h5>Waldorf Astoria Hotels</h5></a>
                                    <div class="room__content__meta">
                                        <span><i class="flaticon-construction"></i>35 sqm</span>
    ...
    <div class="section__shape">
        <div class="shape__one">
            <img src="{{asset('assets/images/shape/testimonial-1.svg')}}" alt="">
        </div>
        <div class="shape__two">
            <img src="{{asset('assets/images/shape/testimonial-1-1.svg')}}" alt="">
        </div>
    </div>
    <div class="container">
        <div class="row justify-content-center text-center mb-40">
    ...
    <div class="rts__section offer__area is__home__one has__shape">
        <div class="section__shape">
            <img src="{{asset('assets/images/offer/section__bg.svg')}}" alt="">
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="gallery__slider overflow-hidden">
                    <div class="swiper-wrapper gallery">
                        <!-- single gallery image -->
                         <div class="swiper-slide">
                            <div class="gallery__item">
                                <a href="{{asset('assets/images/index-3/gallery/1.webp')}}">
                                    <img src="{{asset('assets/images/index-3/gallery/1.webp')}}" alt="">
                                </a>
                            </div>
                         </div>
                        ...
                        <!-- single gallery image -->
                         <div class="swiper-slide">
                            <div class="gallery__item">
                                <a href="{{asset('assets/images/index-3/gallery/2.webp')}}">
                                    <img src="{{asset('assets/images/index-3/gallery/2.webp')}}" alt="">
                                </a>
                            </div>
                         </div>
                        <!-- single gallery image end -->
                        ...
                        <!-- single gallery image -->
                         <div class="swiper-slide">
                            <div class="gallery__item">
                                <a href="{{asset('assets/images/index-3/gallery/3.webp')}}">
                                    <img src="{{asset('assets/images/index-3/gallery/3.webp')}}" alt="">
                                </a>
                            </div>
                         </div>
                        <!-- single gallery image end -->
                        ...
                        <!-- single gallery image -->
                         <div class="swiper-slide">
                            <div class="gallery__item">
                                <a href="{{asset('assets/images/index-3/gallery/4.webp')}}">
                                    <img src="{{asset('assets/images/index-3/gallery/4.webp')}}" alt="">
                                </a>
                            </div>
                         </div>
                        <!-- single gallery image end -->
                        ...
                        <!-- single gallery image -->
                         <div class="swiper-slide">
                            <div class="gallery__item">
                                <a href="{{asset('assets/images/index-3/gallery/1.webp')}}">
                                    <img src="{{asset('assets/images/index-3/gallery/5.webp')}}" alt="">
                                </a>
                            </div>
                         </div>
                        <!-- single gallery image end -->
