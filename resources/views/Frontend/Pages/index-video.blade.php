...
@section('content')
    ...
    <!-- banner area -->
    <div class="rts__section banner__area is__home__video banner__height banner__center">
       <div class="banner__video__section">
            <div class="video__area">
                <video src="{{asset('assets/images/video/Moonlit.mp4')}}" autoplay loop muted></video>
                <div class="video__area__overlay"></div>
            </div>
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-10">
                        <div class="video__section__text">
                            <div class="video__text__slider overflow-hidden">
                                <div class="swiper-wrapper">
                                    
                                    <!-- single slider -->
                                    <div class="swiper-slide">
                                        <div class="video__text__slider__item">
                                            <h1 class="video__text__slider__title">Luxury Stay Hotel Experience Comfort & Elegance</h1>
                                        </div>
                                    </div>
                                    <!-- single slider end -->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="video__text__slider__item">
                                            <h1 class="video__text__slider__title">A Luxurious Retreat Comfort & Elegance Await</h1>
                                        </div>
                                    </div>
                                    <!-- single slider end -->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="video__text__slider__item">
                                            <h1 class="video__text__slider__title">Elevate Your Experience Luxury, Comfort, and Elegance</h1>
                                        </div>
                                    </div>
                                    <!-- single slider end -->
                                </div>
