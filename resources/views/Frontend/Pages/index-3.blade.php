...
@section('content')
    ...
    @include('Frontend.Header.header-two')
    <!-- banner area -->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="banner__slide__content">
                            <h1 class="wow fadeInUp">Luxury Stay Hotel Experience Comfort & Elegance</h1>
    ...
    <!-- about us -->
    <div class="rts__section about__area is__home__two section__padding">
                    ...
                    <div class="image ">
                        <div class="position-relative ">   
                            <div class="jara-mask-1 jarallax image-height">
                                <img src="{{asset('assets/images/about/about-2.webp')}}" class="jarallax-img" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="room__slider overflow-hidden wow fadeInUp" data-wow-delay=".5s">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="room__slide__box radius-6">
                                <div class="room__thumbnail jara-mask-2 jarallax">
                                    <img height="585" width="420" class="radius-6 jarallax-img" src="{{asset('assets/images/room/5.webp')}}" alt="">
                                </div>
                                <div class="room__content">
                        ...
                        <div class="swiper-slide">
                            <div class="room__slide__box radius-6">
                                <div class="room__thumbnail jara-mask-2 jarallax">
                                    <img height="585" width="420" class="radius-6 jarallax-img" src="{{asset('assets/images/room/6.webp')}}" alt="">
                                </div>
                                <div class="room__content">
    ...
    <div class="rts__section offer__area is__home__one has__shape p-0">
        <div class="section__shape">
