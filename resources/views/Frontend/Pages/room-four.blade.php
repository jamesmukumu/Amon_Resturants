        ...
        <div class="container">
            <div class="row gy-5">
                ...
                <div class="room__wrapper">
                    ...
                    @endphp
                    @include('Frontend.Components.room-card-four',compact('thumb','price','title', 'desc'))

                    @php
                        $thumb = "2.webp";
                        $price = "140$";
                        $title = "Single Room";
                        $desc = "Also known as a Classic Room or Single Room, this is the most basic type of room, usually featuring essential amenities.";
                    @endphp
                    @include('Frontend.Components.room-card-four', compact('thumb','price','title', 'desc'))
